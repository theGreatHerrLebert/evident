...
\title{EVIDENT: Claim-Based Evidence Workflows for Scientific Software in the Era of AI-Assisted Development}
...
claim, or a scientific interpretation claim. In this sense, EVIDENT is not a
new assurance-case notation; it is a smaller workflow for applying
claim-evidence discipline where most scientific software is actually reviewed:
inside repositories, test suites, validation reports, and release artifacts.
...
The gap is not that V\&V lacks rigor, but that full V\&V/UQ practice is often
too heavy or too model-centered for smaller claims such as parsers, refactors,
file-format transformations, and implementation-equivalence checks.
...
for. Similarly, an artifact badge can show that an artifact is available,
functional, reusable, or capable of supporting reproduced results, but it does
not by itself localize which implementation, pipeline, or scientific claim that
artifact supports.
...
EVIDENT is therefore not proposed as a replacement for assurance cases, V\&V,
provenance, testing, or reproducibility practice. It is a low-friction binding
layer between these practices and localized scientific-software claims. Its
intended scale is smaller than a regulatory assurance case and more explicit
than a conventional test suite or artifact badge.
...
toy. The purpose of the case study is not to validate Proteon as a tool, but to
test whether EVIDENT exposes heterogeneous evidence quality in a realistic
codebase.
