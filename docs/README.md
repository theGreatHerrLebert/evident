...
| `proposals/` | schema changes under discussion: [`claim-statement.md`](proposals/claim-statement.md) (`claim.statement`, `claim.plain`, `claim.as_stated`) and [`understanding-level.md`](proposals/understanding-level.md) (a recorded, prediction-earned understanding level that raises the validation bar when low; the AutoCoach seam) | no, until merged into `workflow/SCHEMA.md` |
